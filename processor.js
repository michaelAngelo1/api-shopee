...
async function writesOrderDetails(orders) {
    // Placeholder for future implementation
    console.log("Writing to Order Details - Eileen Grace");
}
...
async function fetchAndProcessOrders() {
    ...
    try {
        ...
        if(now.getDate() <= 16) {
            ...
            return { count: allOrdersWithDetail.length, ordersWithDetail: allOrdersWithDetail }
        }
