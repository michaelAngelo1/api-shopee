...
export async function getReturnDetailCLEV(returnList) {
    console.log("CLEV: Get return detail based on return_sn")
...
export async function getReturnListCLEV(timeFrom, timeTo, accessToken) {
    console.log("CLEV: Get return list function");
    ...
    try {
        ...
        console.log("CLEV: Hitting Return List API endpoint: ", fullUrl);
        ...
        if(response && response.data && response.data.response) {
            CLEVReturnList = CLEVReturnList.concat(response.data.response.return);
        }

        return CLEVReturnList;
    } catch (e) {
        console.log("CLEV: error getting return list: \n", e);
    }
}